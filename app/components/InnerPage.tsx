...
const routes = ["/shop", "/collection", "/custom-orders", "/about", "/admin"];
const menuLabels = { en: ["Shop", "Collection", "Custom Orders", "About", "Admin"], am: ["ይግዙ", "ስብስብ", "ብጁ ትዕዛዝ", "ስለ እኛ", "አስተዳዳሪ"] };
const pageCopy = {
  ...
  return (
    <main className="inner-page">
      ...
      <header className="site-header page-header scrolled">
        ...
        <div className="header-actions"><button className="header-action selection-action" data-mobile-label={language === "en" ? "Bag" : "ቦርሳ"} onClick={() => setSelectionOpen(true)}>{language === "en" ? "Bag" : "ቦርሳ"} <span>{selection.length}</span></button><ProfileControl language={language} /></div>
      </header>
